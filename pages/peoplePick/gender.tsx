      ...
      <div className="details">
        <div className="details-main">
          <div className="details-left">
            ...
            <div className="details-Image">
              <Image
                src={`https://nimage.g-enews.com/phpwas/restmb_allidxmake.php?idx=5&simg=2021060116314805691bc88014e31123313623.jpg`}
                alt=""
                width={`93px`}
                height={`93px`}
                unoptimized={true}
          ...
          <div className="details-right">
            <div className="details-title">
              알티지 오메가3 30정, 멀티 비타민 우먼 30정, 밀크씨슬 정 30정
            </div>
            <div className="details-subTitle">
              <div className="details-company">(주)바이오퍼블릭</div>
              <div className="details-counts">60일분</div>
            </div>
          </div>
        </div>
      ...
      <div className="details">
        <div className="details-main">
          <div className="details-left">
            ...
            <div className="details-Image">
              <Image
                src={`http://cdn.bosa.co.kr/news/photo/202103/2145235_178181_5046.jpg`}
                alt=""
                width={`93px`}
                height={`93px`}
                unoptimized={true}
          ...
          <div className="details-right">
            <div className="details-title">
              V-pack Man 브이-팩 남성용 All in One 건강기능식품
            </div>
            <div className="details-subTitle">
              <div className="details-company">㈜한풍네이처팜</div>
              <div className="details-counts">60일분</div>
