...
const home = () => {
  return (
    <div className="w-full h-full flex flex-col items-center relative bg-gradient-to-r from-green to-gradientBlue">
      ...
      <div className="w-[500px] h-full bg-lightGray absolute top-[200px] z-40 rounded-t-[30px] blur-sm" />
      ...
      <SearchInput top={168} />
      <h1 className="z-40 text-white absolute top-[129px] left-[30px] font-sdg-b">
        홍길동님, 반가워요
      </h1>
    </div>
  );
