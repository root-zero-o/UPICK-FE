const PickUpNotice = () => {
  return (
    <div className="flex flex-col items-center fixed bottom-0  w-[70%] bg-coolgray1 h-[180px] shadow-pick_up_shadow ">
      <div className="w-[80%] mb-1">
        <span>아이콘</span>
        <span className="ml-2 text-md text-blue2">픽업 관련 안내</span>
      </div>
      <div className="text-sm px-[5%] bg-blue4 mt-4 flex flex-col items-start justify-center w-[90%] h-fit  shadow-lg rounded-lg">
