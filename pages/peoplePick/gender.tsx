...
import { EffectPick, GenderPick } from "store/modules/peoplePickSlice";
  ...
  return (
    <div className="w-full flex flex-col py-8 relative space-y-6 overflow-x-hidden mb-[55px]">
      ...
      <div className="semiCategory">
        {gender === "male" ? (
          <div className="semiCategory-selected" onClick={onMaleClick}>
            남성
          </div>
        ) : (
          <div className="semiCategory-Text" onClick={onMaleClick}>
            남성
          </div>
        )}
        {gender === "female" ? (
          <div className="semiCategory-selected" onClick={onFemaleClick}>
            여성
          </div>
        ) : (
          <div className="semiCategory-Text" onClick={onFemaleClick}>
            여성
          </div>
        )}
      </div>
